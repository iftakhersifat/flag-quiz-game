      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col sm:flex-row justify-between items-center border-b border-gray-700 pb-6">
          <div className="text-center sm:text-left mb-6 sm:mb-0">
            <h2 className="text-xl font-bold text-amber-500">Flag Quiz Game</h2>
            <p className="text-sm text-gray-400 mt-1">
              © {new Date().getFullYear()} Flag Quiz Game. All rights reserved.
            </p>
          </div>
        ...
        <div className="text-center text-sm text-gray-400 mt-4">
          <p>
            Developed with ❤️ by{' '}
            <span className="text-amber-500 font-medium">Iftakher Hossen Sifat</span>
          </p>
        </div>
      </div>
    </footer>
